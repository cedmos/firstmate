...
state/               runtime records and signals; gitignored
  ...
  branch-pending-wakes/  accepted Pi branch dispatches awaiting branch completion or replacement-session fallback; extension-owned (docs/pi-supervision-branch.md)
